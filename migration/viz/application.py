...
def _repo_root() -> Path:
    # notebooks/scripts/application.py -> notebooks/scripts -> notebooks -> repo
...
from field_error import ErrorSettings, compute_error_fields, evaluate_field, load_lebedev_grid  # noqa: E402
...
def _shg_long():
    ...
    csv_path = _repo_root() / "data" / "csv_data" / "shg_ijk.csv"
...
def _load_molecule(mol_name: str):
    ...
    return qcel.models.Molecule(symbols=mol_json["symbols"], geometry=mol_json["geometry"])
